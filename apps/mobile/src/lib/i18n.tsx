...
const es = {
  ...
  'privacy.delete.body': 'Se borra todo lo que guardamos de ti: tu histórico de viajes, el registro de alertas, el recorrido en curso, tus preferencias y tu identificador anónimo, aquí y en el servidor. Es irreversible y no se puede recuperar.',
  ...
  'privacy.delete.confirmBody': 'No hay vuelta atrás. Tu histórico y tus preferencias se pierden para siempre.',
  ...
  'privacy.deleted.partial': 'Se borró lo del teléfono, pero el servidor no respondió. Vuelve a intentarlo con conexión para completar el borrado.',
  ...
  'wel.report.body': 'Un reporte anónimo tarda diez segundos y mejora el mapa de todos. Lo que aporta la comunidad vuelve a la comunidad.',
...
const en: Record<TKey, string> = {
  ...
  'privacy.delete.body': 'This deletes everything we keep about you: your trip history, alert log, current trip, preferences and anonymous identifier, both here and on the server. It cannot be undone.',
  ...
  'privacy.delete.confirmBody': 'There is no going back. Your history and preferences are lost forever.',
  ...
  'privacy.deleted.partial': 'Phone data was deleted, but the server did not respond. Try again with a connection to complete the deletion.',
  ...
  'wel.report.body': 'An anonymous report takes ten seconds and improves everyone’s map. What the community adds goes back to the community.',
