...
const es = {
  ...
  // Segundo plano: el usuario siempre sabe si la protección sigue viva fuera de la app.
  'map.bg.on': 'Protección activa aunque bloquees el teléfono o cambies de app.',
  'map.bg.off': 'Para cuidarte con la pantalla apagada, permite la ubicación «Siempre» en los ajustes del sistema.',
  'map.bg.notifTitle': 'Nómada.AI cuida tu recorrido',
  'map.bg.notifBody': 'Seguimos tu ruta para avisarte antes de las zonas de riesgo.',
  'map.banner.tripResumed': 'Retomamos tu recorrido en curso.',
...
const en: Record<TKey, string> = {
  ...
  'map.bg.on': 'Protection stays on even if you lock the phone or switch apps.',
  'map.bg.off': 'To keep you safe with the screen off, allow "Always" location in system settings.',
  'map.bg.notifTitle': 'Nómada.AI is watching your trip',
  'map.bg.notifBody': 'We follow your route to warn you before risky areas.',
  'map.banner.tripResumed': 'We picked up your trip where you left it.',
