...
const es = {
  ...
  'settings.autoTrip': 'Recorrido libre automático',
  'settings.autoTrip.help': 'Al detectar que te mueves (~15 km/h), la protección se activa sola. Para eso Android pedirá «Permitir siempre» la ubicación: solo se usa para cuidarte en el camino, nunca para otra cosa.',
...
const en: Record<TKey, string> = {
  ...
  'settings.autoTrip': 'Automatic free ride',
  'settings.autoTrip.help': 'When we detect you moving (~15 km/h), protection turns on by itself. Android will ask to “Allow all the time” for location: it is only used to protect you on the road, never for anything else.',
