...
function AppleMark() {
  return (
    <svg className="dl-badge-ic" viewBox="0 242 814 758" fill="currentColor" aria-hidden="true">
      <path d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76.5 0-103.7 40.8-165.9 40.8s-105.6-57-155.5-127C46.7 790.7 0 663 0 541.8c0-194.4 126.4-297.5 250.8-297.5 66.1 0 121.2 43.4 162.7 43.4 39.5 0 101.1-46 176.3-46 28.5 0 130.9 2.6 198.3 99.2zm-234 361.3c25.1-33.4 42.5-79.9 42.5-126.4 0-6.4-.5-12.9-1.7-18.1-40.5 1.5-88.7 27-117.7 60.7-23 26.1-44.6 72.6-44.6 119.8 0 7.1 1.2 14.2 1.7 16.5 2.6.5 6.8 1.2 11 1.2 36.3 0 81.9-24.4 108.8-53.7z" />
    </svg>
  );
}
